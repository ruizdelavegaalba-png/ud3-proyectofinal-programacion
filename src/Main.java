public class Main {
    public static void main(String[] args) {
        // Crear 3 conciertos
        Concierto concierto1 = new Concierto("Coldplay", "Madrid", 50.0, 5000);
        Concierto concierto2 = new Concierto("Rosalía", "Barcelona", 45.0, 3000);
        Concierto concierto3 = new Concierto("Metallica", "Sevilla", 60.0, 8000);

        // Crear 3 usuarios
        Usuario usuario1 = new Usuario("Ana García", 25);
        Usuario usuario2 = new Usuario("Pedro López", 30);
        Usuario usuario3 = new Usuario("María Rodríguez", 28);
